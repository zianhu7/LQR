...
def run(args, parser, env_params):
    ...
    print("Results: ", args.low[0], args.high[0], rel_reward / num_episodes, total_stable / num_episodes)
    if args.out is not None:
...
if __name__ == "__main__":
    ...
    env_params = {"horizon": 120, "exp_length": 6, "reward_threshold": -10, "eigv_low": 0.5, "eigv_high": 2,
                  "q_scaling": [0, 1], "r_scaling": [1, 1]}

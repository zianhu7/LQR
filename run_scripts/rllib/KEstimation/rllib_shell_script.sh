...
ray exec ../../../ray_autoscale.yaml "python LQR/run_scripts/rllib/KEstimation/k_script.py dim1_stability_end --dim 1 \
    --num_cpus 15 --grid_search 1  --use_s3 1 --checkpoint_freq 100 --num_iters 2000 \
    --eigv_high 2.0 --eigv_low 0.5 --stability_scaling 50 --elem_sample 1 --horizon 120 --exp_length 6 --end_scaling True" \
    --start --stop --cluster-name ethan_ke2 --tmux

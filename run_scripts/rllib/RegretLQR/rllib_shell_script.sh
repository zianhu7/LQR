...
ray exec ../../../ray_autoscale.yaml "python LQR/run_scripts/rllib/RegretLQR/run_exp_rllib.py dim3_full_ls_regret_d100 --dim 3 \
    --num_cpus 36 --use_s3 1 --checkpoint_freq 100 --num_iters 2500 --multi_node 1 --grid_search 1 --done_norm_cond 100" \
    --start --stop --cluster-name 3_reg2 --tmux

...
class LQRKEnv(gym.Env):
    ...
    def __init__(self, env_params): #Normalize Q, R
        ...
        self.action_space = spaces.Box(low=-math.inf, high=math.inf, shape=(self.dim*self.dim,))
